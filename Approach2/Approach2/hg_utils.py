...
class GenerationMixin:
    ...
    def _prepare_model_inputs(
        ...
        if (
            ...
            and self.encoder.main_input_name != self.model.main_input_name
        ):
    ...
    def _maybe_initialize_input_ids_for_generation(
        ...
        for value in model_kwargs.values():
            if isinstance(value, torch.Tensor):
                ...
                break
        return torch.ones((batch_size, 1), dtype=torch.long, device=self.model.device) * bos_token_id
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        if return_dict_in_generate:
            ...
            return input_ids, all_linear_logits
